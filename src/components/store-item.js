			    ...
			    <div className={item}>
			    	<div className={itemTop}>
				    	...
				    	<p className={itemDescription}>{node.frontmatter.Format_Name}</p>
							...
							<input type="checkbox" id={`${node.slug} quickViewToggler`} className={inputViewToggler}/>
							<label htmlFor={`${node.slug} quickViewToggler`} className={quickViewToggler}><span className={quickViewOpen}>Quick view</span><span className={quickViewClose}>Close</span></label>
